...
func TestNullUUIDValue(t *testing.T) {
	...
	u = MustParseUUID("12345678-abcd-1234-abcd-0123456789ab")
	nu = NullUUID{
		UUID:  MustParseUUID("12345678-abcd-1234-abcd-0123456789ab"),
		Valid: true,
	}
...
func TestNullUUIDMarshalJSON(t *testing.T) {
	...
	jsonUUID, _ := json.Marshal(MustParseUUID("12345678-abcd-1234-abcd-0123456789ab"))
	tests := []struct {
		nullUUID    NullUUID
		expected    []byte
		expectedErr error
		...
		{
			nullUUID: NullUUID{
				UUID:  MustParseUUID(string(jsonUUID)),
				Valid: true,
			},
