...
// Sequence is a KSUID generator that produces a sequence of ordered KSUIDs
// from a seed.
//
...
type Sequence struct {
	// The seed is used as a base for the KSUID generator, all generated KSUIDs
...
func (seq *Sequence) Next() (KSUID, error) {
	...
	if count > math.MaxUint16 {
		return NilKSUID, errors.New("too many IDs were generated")
	}
	seq.count++
